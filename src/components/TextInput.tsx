  ...
  return (
    ...
    >
      ...
      <TextArea
        ...
        rows={3}
        className="w-full px-4 py-2 border border-2 border-[rgba(45,212,168,0.1)] rounded-sm font-mono text-lg leading-relaxed bg-[rgba(17,24,39,0.5)] text-[#f9fafb] resize-y min-h-20 transition-all duration-300 placeholder:text-[#6b7280] focus:outline-none focus:border-[rgba(45,212,168,0.5)] focus:shadow-[0_0_30px_rgba(45,212,168,0.15),inset_0_0_20px_rgba(45,212,168,0.05)]"
      />
    </TextField>
  );
}
